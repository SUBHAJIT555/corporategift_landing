        ...
        >
          <div className="max-w-3xl text-white " >
            ...
            <motion.button
              variants={fadeIn}
            >
              <Link target="_blank" to={`https://wa.me/+971526240517}`} className="inline-flex items-center gap-2 sm:gap-3 bg-white text-gray-900 px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-medium text-sm sm:text-base w-full sm:w-auto justify-center">
