...
const Why = () => {
  ...
  // Bottom to top animation with smooth easing
  ...
  // Right to left animation with smooth easing
  ...
  // Left to right animation with smooth easing
  ...
  // Scale up animation with smooth easing
  ...
  // Slide up with rotation - smooth version
  const slideUpRotateVariants = {
    hidden: {
      opacity: 0,
      y: 30,
      rotateX: -10,
        ...
        <div className="w-full py-6 sm:py-10 md:py-20 px-3 sm:px-5 md:px-15">
          ...
          >
            ...
            <motion.div
              ...
              variants={slideUpRotateVariants}
            >
              {/* Image div */}
